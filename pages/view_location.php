...
$query1 ="SELECT * FROM `digital_addresses` WHERE `S.No` = '$s_no'";
...
<body>
		...
		<div id="container">
		  ...
		  <div id="infoi">
				...
				<div class="col col-2">
					<div class="box"><div class="content1"><h1 class="lead display-4"> <span style="font-weight:bold"></span> <?php
					$s_no = $_GET['s_no'];
